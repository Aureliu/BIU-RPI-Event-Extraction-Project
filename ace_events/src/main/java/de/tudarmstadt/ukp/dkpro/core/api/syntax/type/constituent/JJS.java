 ...
 * @generated */
public class JJS extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected JJS() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public JJS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public JJS(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public JJS(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
