...
# `make test'. After `make install' it should work as `perl t/lin.t'
...
$m = WordNet::Similarity::lin->new($wn);
if($m)
{
...
############ Load lin with undef QueryData.

$bad = WordNet::Similarity::lin->new(undef);
if($bad)
{
