 ...
 *
 */
public class MyParserGui extends JFrame implements ActionListener
{
	...
	//private final static Class<? extends NodeAndEdgeString<Info>> nodeAndEdgeStringClass = LemmaCanonicalPosNodeAndEdgeString.class;
	...
	private class GraphComponent extends JComponent
	{
		...
		private MyParserGui parserGui = null;
		public GraphComponent(MyParserGui theParserGui)
		{
			super();
	...
	private static void createAndShowGUI(BasicParser parser)
	{
		...
		final MyParserGui frame = new MyParserGui("Parser GUI - " + parser.getClass().getSimpleName(),parser);
    ...
    private MyParserGui(String title,BasicParser parser) throws HeadlessException
    {
		super(title);
		this.parser = parser;
	}
