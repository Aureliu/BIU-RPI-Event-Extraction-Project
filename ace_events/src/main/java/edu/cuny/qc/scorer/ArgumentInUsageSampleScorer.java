...
public abstract class ArgumentInUsageSampleScorer extends ArgumentScorer<ArgumentExample> {
...
//		try {
//			PartOfSpeech textPos = AnnotationUtils.tokenToPOS(textTriggerToken);
//			
...
//					getForm(textTriggerToken), textPos, scorerData.derivation.leftOriginal, scorerData.derivation.leftDerivation, scorerData.leftSenseNum);
//			
...
//					result = calcBoolPredicateSeedScore(textTriggerToken, textTriggerTokenMap, textDerv.lLemma, textDerv.lPos, specDerv.lLemma, specDerv.lPos, scorerData);
//					if (result) {
//						if (debug) {
