 ...
 * @generated */
public class VBG extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected VBG() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public VBG(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public VBG(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public VBG(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
