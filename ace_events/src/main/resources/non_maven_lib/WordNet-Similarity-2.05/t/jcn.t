...
# `make test'. After `make install' it should work as `perl t/jcn.t'

# A script to test the Jiang-Conrath (jcn.pm) measure.  This script runs the
# following tests:
#
...
$m = WordNet::Similarity::jcn->new($wn);
if($m)
{
...
############ Load jcn with undef QueryData.

$bad = WordNet::Similarity::jcn->new(undef);
if($bad)
{
