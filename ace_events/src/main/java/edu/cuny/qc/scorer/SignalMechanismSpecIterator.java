...
public abstract class SignalMechanismSpecIterator implements Iterator<BigDecimal> {
	...
	public SignalMechanismSpecIterator init(JCas spec, String viewName, AnnotationFS covering, Class<? extends Annotation> type, Annotation textAnno, Map<Class<?>, Object> textTriggerTokenMap) throws SignalMechanismException {
		try {
			if (covering != null) {
...
//			}
	...
	public BigDecimal next() {
		try {
			...
			BigDecimal result = calcScore(textAnno, textTriggerTokenMap, specElement);
			addToHistory(result);
			return result;
	...
	public abstract BigDecimal calcScore(Annotation text, Map<Class<?>, Object> textTriggerTokenMap, Annotation spec) throws SignalMechanismException;
