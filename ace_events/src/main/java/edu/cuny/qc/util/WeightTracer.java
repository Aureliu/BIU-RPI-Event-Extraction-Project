...
public class WeightTracer {
	...
	private List<String> FEATURES_TO_PRINT = Arrays.asList(new String[] {
			"BigramFeature:	W=war		currentLabel:Attack",
			"BigramFeature:	W=war		currentLabel:O",
			"BigramFeature:	W=example		currentLabel:Attack",
			"BigramFeature:	W=example		currentLabel:O",
			"BigramFeature:	W=occupies		currentLabel:O",
			});
