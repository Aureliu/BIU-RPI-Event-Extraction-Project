...
public class TestClusterSeq
{
	...
	static public void main(String[] args) throws IOException
	{
		...
		Perceptron.serializeObject(perceptron, new File("model_cluster_seq"));
		
		// read model from the serialized file
		perceptron = (PerceptronCluster) PerceptronCluster.deserializeObject(new File("model_cluster_seq"));
		...
		PrintStream out = new PrintStream(new File("weights_cluster_seq"));
