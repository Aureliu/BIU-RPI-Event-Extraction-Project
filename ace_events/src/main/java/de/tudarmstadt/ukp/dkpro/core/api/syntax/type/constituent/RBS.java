 ...
 * @generated */
public class RBS extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected RBS() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public RBS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public RBS(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public RBS(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
