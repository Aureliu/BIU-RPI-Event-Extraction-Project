 ...
 * @generated */
public class WPP extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected WPP() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public WPP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public WPP(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public WPP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
