 ...
 * @generated */
public class NNS extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected NNS() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public NNS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public NNS(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public NNS(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
