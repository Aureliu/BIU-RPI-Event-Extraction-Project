 ...
 * @generated */
public class NNP extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected NNP() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public NNP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public NNP(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public NNP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
