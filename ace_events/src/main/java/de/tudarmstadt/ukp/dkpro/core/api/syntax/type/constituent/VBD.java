 ...
 * @generated */
public class VBD extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected VBD() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public VBD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public VBD(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public VBD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
