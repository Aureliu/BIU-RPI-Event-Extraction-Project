 ...
 * @generated */
public class VBP extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected VBP() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public VBP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public VBP(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public VBP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
