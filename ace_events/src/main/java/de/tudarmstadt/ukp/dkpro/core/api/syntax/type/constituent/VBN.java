 ...
 * @generated */
public class VBN extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected VBN() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public VBN(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public VBN(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public VBN(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
